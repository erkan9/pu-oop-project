...
public class Board extends JComponent {
    ...
    private void getRedKilledPieces() {
        ...
        for (int index = 0; index < 6; index++) {
            ...
            if (this.redPLayerKilledPiece.get(index) != null) {
                ...
                System.out.printf("[%d][%s] - Killed Red Piece\n",index + 1 , this.redPLayerKilledPiece.get(index));
            }
        }
    }
    ...
    private void getBlackKilledPieces() {
        ...
        for (int index = 0; index < 6; index++) {
            ...
            if (this.blackPLayerKilledPiece.get(index) != null) {
                ...
                System.out.printf("[%d][%s] - Killed Black Piece\n", index + 1, this.blackPLayerKilledPiece.get(index));
            }
        }
    }
    ...
    private void checkIfGameOver() {
        ...
        if (redPlayer.getKilledPieces() >= 6 || blackPlayer.getKilledPieces() >= 6) {
    ...
    public void showMessageWhenGameOver() {
        ...
        if(redPlayer.getKilledPieces() == 6) {
